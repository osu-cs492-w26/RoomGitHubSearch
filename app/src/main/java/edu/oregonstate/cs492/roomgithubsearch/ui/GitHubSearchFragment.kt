...
import edu.oregonstate.cs492.roomgithubsearch.util.LoadingStatus
import edu.oregonstate.cs492.roomgithubsearch.util.buildGitHubQuery
...
//        )
        ...
        searchBtn.setOnClickListener {
            ...
            if (!TextUtils.isEmpty(query)) {
                val sort = sharedPrefs.getString(getString(R.string.pref_sort_key), null)
                val user = sharedPrefs.getString(getString(R.string.pref_user_key), null)
                val languages = sharedPrefs.getStringSet(getString(R.string.pref_language_key), null)
                val firstIssues = sharedPrefs.getInt(getString(R.string.pref_first_issues_key), 0)
